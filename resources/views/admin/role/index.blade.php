...
<main class="ease-soft-in-out xl:ml-68.5 relative h-full max-h-screen rounded-xl transition-all duration-200">
    ...
    <div class="w-full px-6 py-6 mx-auto">
      ...
      <!-- cards row 1 -->
      <div class="flex flex-wrap mb-4 bg-white shadow-soft-xl rounded-2xl bg-clip-border">
        <!-- card1 -->
        ...
        <div class="w-full max-w-full px-3 sm:w-1/2 sm:flex-none xl:mb-0 xl:w-1/2">
            {{-- <div class="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border"> --}}
              <div class="flex-auto p-4">
                <div class="flex flex-row -mx-3">
                  <div class="px-3 text-right w-full">
                      <button type="button" class="sm:w-1.25rem w-full inline-block px-6 py-3 mr-3 font-bold text-center uppercase align-middle transition-all bg-transparent border rounded-lg cursor-pointer border-fuchsia-500 leading-pro text-xs ease-soft-in tracking-tight-soft shadow-soft-md bg-150 bg-x-25 hover:scale-102 active:opacity-85 hover:shadow-soft-xs text-fuchsia-500">Button</button>
